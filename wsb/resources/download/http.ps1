...
Try {
    ...
    Download-GitHub -repo "mandiant/flare-fakenet-ng" -path "$($PSScriptRoot)\..\..\tools\downloads\fakenet.zip"
    ...
    Download-GitHub -repo "radareorg/radare2" -path "$($PSScriptRoot)\..\..\tools\downloads\radare2.zip"
