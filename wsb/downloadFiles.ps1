...
$DidierStevensSuiteArray = "1768.json","1768.py","base64dump.py","byte-stats.py","count.py","cs-analyze-processdump.py","cs-decrypt-metadata.py", `
...
foreach ($Tool in $DidierStevensSuiteArray)
{
